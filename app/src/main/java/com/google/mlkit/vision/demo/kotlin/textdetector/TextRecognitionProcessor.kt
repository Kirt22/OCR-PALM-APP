...
class TextRecognitionProcessor(
  ...
  private lateinit var textForBardCallBack: TextForBardCallBack

  constructor(context: Context,
              textRecognizerOptions: TextRecognizerOptionsInterface , textForBardCallBack: TextForBardCallBack) :
          this(context, textRecognizerOptions) {
    this.textForBardCallBack = textForBardCallBack
  }
  ...
  override fun onSuccess(text: Text, graphicOverlay: GraphicOverlay) {
    ...
    val imageToText = text.textBlocks[0].text
    textForBardCallBack.sendToActivity(imageToText)
  ...
  interface TextForBardCallBack {
    fun sendToActivity(textFromImage: String)
  }
